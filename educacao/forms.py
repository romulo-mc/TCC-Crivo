...
class RecursoEducativoForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['titulo', 'tipo', 'descricao', 'arquivo', 'capa', 'alt_text', 'codigo_incorporacao', 'url_externa', 'baixar_pdf']
        widgets = {
            ...
            'alt_text': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ex: Cartaz roxo mostrando um homem amputado de braços abertos...'}),
            ...
            'baixar_pdf': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
        }